...
const AmqpMessage_1 = require("../core/AmqpMessage");
...
const custom_class_1 = require("./custom-class");
...
__decorate([
    Consumer_1.Consumer({ queue: "TEST_QUEUE_2", consumers: 1 }),
    __param(0, InjectData_1.InjectData()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [AmqpMessage_1.AmqpMessage]),
    __metadata("design:returntype", void 0)
], TestConsumer.prototype, "testMethod", null);
TestConsumer = __decorate([
    AmqpController_1.AmqpController(),
    __param(0, InjectChannel_1.InjectChannel()), __param(1, InjectConnection_1.InjectConnection()), __param(2, ContainerInject_1.ContainerInject(custom_class_1.CustomClass)),
    __metadata("design:paramtypes", [Object, Object, custom_class_1.CustomClass])
], TestConsumer);
